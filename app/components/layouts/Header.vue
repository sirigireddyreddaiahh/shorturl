...
// Use /dashboard which will auto-redirect based on auth status
// This is simpler and works for both logged in and logged out users
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <a
                class="w-full px-6 py-2 mr-0 text-gray-700 cursor-pointer dark:text-gray-300 md:px-3 md:mr-2 lg:mr-3 md:w-auto hover:text-gray-900 dark:hover:text-white"
                :href="dashboardLink"
